...
<div class="pt-15 w-4/5 m-auto">
    <a
     href="/blog/create"
     class="bg-gray-700 uppercase bg-transparent text-gray-100 text-xs font-extrabold py-3 px-5 rounded-3xl">
     Create Post</a>
</div>
@endif
...
<div>
    ...
    <a 
    href="/blog/{{$post->slug}}"
    class="uppercase bg-gray-800 text-gray-100 text-lg
...
<span class="float-right">
    <a
     ...
     class="bg-gray-700 uppercase italic hover:text-gray-900 pb-1 border-b-2">
     Edit </a>
</span>
@endif
